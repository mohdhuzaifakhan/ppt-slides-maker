...
import { type Message, type Presentation, type GenerateSlidesResponse } from "@shared/schema";
...
export default function Home() {
  ...
  const [selectedSlideIndex, setSelectedSlideIndex] = useState<number | undefined>(undefined);
